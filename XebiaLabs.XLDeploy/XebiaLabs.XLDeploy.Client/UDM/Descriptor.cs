...
namespace XebiaLabs.Deployit.Client.UDM
{
    ...
    public class Descriptor : UdmBase
    {
        [XmlAttribute("type")]
        ...
        [XmlArray("superTypes")]
        [XmlArrayItem("superType")]
        public string[] Supertypes { get; set; }

        [XmlArray("property-descriptors")]
        [XmlArrayItem("property-descriptor", typeof (DescriptorProperty))]
        ...
        public bool IsArtifact
        {
            get
            {
                return Interfaces != null && Interfaces.Contains("udm.DeployableArtifact");
            }
        }
    }
}
