...
{
	internal class XmlHttpContent : IOutputHttpContent<XDocument>
	{
		public XDocument Deserialize(HttpContent content)
		{
		    return XDocument.Parse(content.ReadAsStringAsync().Result);
		}
	}
}
