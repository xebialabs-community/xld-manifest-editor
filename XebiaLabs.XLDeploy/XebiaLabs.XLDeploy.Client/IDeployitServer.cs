...
{
    public interface IDeployitServer
    {
        Uri URL { get; }
        string UserName { get; }
        ConnectionStatus LastConnectionStatus { get; }
        void Disconnect();
        ConnectionStatus Connect(Uri url, NetworkCredential credentials, bool checkConnection=true);
